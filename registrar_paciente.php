  ...
  <div class="col-8">
    <form action="app/guardar_paciente.php" method="POST" class="patient-form formulario">
      ...
      <div class="row d-flex">
        ...
        <div class="col-6">
          ...
          <div class="mb-3 text-center">
            ...
            <input type="text" id="osocial" name="osocial" required class="form-control" />
          </div>

          <div class="mb-3 text-center">
            <label for="nroafiliado" class="form-label">Numero de Afiliado:</label>
            <input type="text" id="nroafiliado" name="nroafiliado" required="" class="form-control" />
          </div>

          <div class="mb-3 text-center">
            <label for="plan" class="form-label">Plan:</label>
            <input type="text" id="plan" name="plan" required="" class="form-control" />
          </div>
      ...
      <div class="col-12 d-flex justify-content-center">
        <button type="submit" class="btn btn-primary btn-submit align-items-center">
          Registrar Paciente
        </button>
      </div>
    </form>
